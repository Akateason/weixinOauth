...
//		Unirest.shutdown() ;  // in terminate app .
    ...
    public static String doGet(String url, Map<String, Object>paramMap) throws UnirestException {
    ...
    public static String doGet(String urlComplete) throws UnirestException {
    	GetRequest request = Unirest.get(urlComplete) ;
    	HttpResponse<String> response = request.asString() ;
    	String returnString = response.getBody().toString() ;
//    	HttpResponse<JsonNode> jsonResponse = request.asJson() ;
//    	String returnString = jsonResponse.getBody().toString() ;         
    	return returnString ;   
    }
