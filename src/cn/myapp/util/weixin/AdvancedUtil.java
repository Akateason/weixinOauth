...
import com.weixin.oauth.model.WeixinUserInfo;
...
public class AdvancedUtil {
	...
	*/
	 ...
	 */
	@SuppressWarnings({ })
	public static SNSUserInfo getSNSUserInfo(String accessToken, String openId) throws UnirestException {
		...
		requestUrl = requestUrl.replace("ACCESS_TOKEN", accessToken).replace(
				"OPENID", openId);
		// 通过网页授权获取用户信息
		String resp = HttpRequest.doGet(requestUrl) ;
		System.out.println(resp);
		
		if (null != resp) {
			try {
				Gson gson = new Gson() ;
				snsUserInfo = gson.fromJson(resp, SNSUserInfo.class) ;										
			} catch (Exception e) {
				snsUserInfo = null;;
